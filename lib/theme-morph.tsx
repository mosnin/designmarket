...
export const morphPresets: readonly MorphPreset[] = [
  {
    ...
    light: {
      ...
      "card-foreground": "#0a0a0a", popover: "#ffffff", "popover-foreground": "#0a0a0a",
      primary: "#0066ff", "primary-foreground": "#ffffff",
      secondary: "#f5f5f5", "secondary-foreground": "#0a0a0a",
      muted: "#f5f5f5", "muted-foreground": "#737373",
      accent: "#eff5ff", "accent-foreground": "#0066ff",
      destructive: "#dc2626", "destructive-foreground": "#ffffff",
      border: "#e5e5e5", input: "#e5e5e5", ring: "#0066ff", radius: "0.625rem",
    },
    dark: {
      background: "#0a0a0a", foreground: "#fafafa", card: "#141414",
      "card-foreground": "#fafafa", popover: "#202020", "popover-foreground": "#fafafa",
      primary: "#3b82f6", "primary-foreground": "#ffffff",
      secondary: "#202020", "secondary-foreground": "#fafafa",
      muted: "#202020", "muted-foreground": "#a1a1a1",
      accent: "#1f1f1f", "accent-foreground": "#3b82f6",
      destructive: "#f87171", "destructive-foreground": "#0a0a0a",
      border: "#262626", input: "#262626", ring: "#3b82f6", radius: "0.625rem",
    },
  },
  {
    id: "slate",
